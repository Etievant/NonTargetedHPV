...
# Part 1, for n = 5,000 and 10,000
# Code for n = 50,000 is given in Simul_NonRandomized_Part2.R
...
# Sample sizes
N     = c(5 * 10^3, 10^4)       # simulations with n = 5 * 10^4  are performed in Simul_NonRandomized_Part2.R
...
Onerun = function(p){
  ...
  myfile  = paste0("RES_NonRandomized-n", n, "-pY1", paste(pY1, collapse = "_"), "-A", paste(a, collapse = "_"), "-beta1", paste(round(beta_1, digits = 3), collapse = "_"), ".RData")
