...
Onerun = function(p){
  ...
  myfile  = paste0("RES_NonRandomized_TreatmentEffectY2_Part1-n", n, "-pY1", paste(pY1, collapse = "_"), "-A", paste(a, collapse = "_"), "-beta1", paste(round(beta_1, digits = 3), collapse = "_"), ".RData")
...
for(p in 1: nrow(PARAM)){
  ...
  load(paste0("RES_NonRandomized_TreatmentEffectY2_Part1-n", n, "-pY1", paste(pY1, collapse = "_"), "-A", paste(a, collapse = "_"), "-beta1", paste(round(beta_1, digits = 3), collapse = "_"), ".RData"))
  RES = rbind(RES, res)
}
...
myfile  = paste0("RECAP_NonRandomized_TreatmentEffectY2_Part1-beta1", paste(round(beta_1, digits = 3), collapse = "_"), ".RData")
...
grid.draw(z)
# Save the plot
pdf(paste0("Comparison_NonRandomized_TreatmentEffectY2_Part1-beta1", paste(round(beta_1, digits = 3), collapse = "_"), ".pdf"),  width = 10, height = 7)
...
beta_1          = c(beta_1.16, beta_1.18)
myfile  = paste0("Eff_NonRandomized_TreatmentEffectY2_Part1-beta1", paste(round(beta_1, digits = 3), collapse = "_"), ".RData")  # save as Rdata
